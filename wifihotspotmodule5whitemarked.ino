...
void forward(){
  ...
  if (WiFi.status() == WL_CONNECTED) { //Check WiFi connection status
    ...
    http.begin("http://192.168.4.1:80/gpio2/1");  //Specify request destination
    ...
    http.begin("http://192.168.4.1:80/gpio2/0");  //Specify request destination
...
//============================================================
  ...
  void setup()
  {
    ...
    SetWifi("module5", "iammodule5");
    WiFi.begin("module4", "iammodule4");      // The SSID That We Want To Connect To
